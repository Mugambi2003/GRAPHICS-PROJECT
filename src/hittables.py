"""
    The main purpose of this is to create the many mini-`spheres with different
    transformation to show ray tracing and how light affects it
"""
import taichi as ti
from vector import *
import ray
...
import random
import numpy as np
from bounding_volume_hierachy import BVH
