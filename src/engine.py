...
class Engine:
    ...
    def makeAssets(self) -> None:
        ...
        self.shader = self.createShader("src/shaders/frameBufferVertex.txt",
                                        "src/shaders/frameBufferFragment.txt")
        
        self.rayTracerShader = self.createComputeShader("src/shaders/rayTracer.txt")
