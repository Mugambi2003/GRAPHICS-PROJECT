...
Sc = Scene()
Sc.add_Camera(look_from=vec3(0., 0.25, 1.), look_at=vec3(0., 0.25, -3.), screen_width=1600, screen_height=1200)
...
output_path = os.path.join(output_directory, "cube.png")
